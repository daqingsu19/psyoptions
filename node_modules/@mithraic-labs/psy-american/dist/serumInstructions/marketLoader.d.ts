 ...
 * @returns
 */
export declare const marketLoader: (program: Program, optionMarketKey: PublicKey, marketAuthorityBump: number, dexProgramId: PublicKey, marketKey: PublicKey) => Promise<import("@project-serum/serum").MarketProxy>;
