 ...
 * @returns
 */
export declare const cancelOrderInstructionV2: (program: Program, optionMarketKey: PublicKey, dexProgramId: PublicKey, serumMarketKey: PublicKey, order: Order, marketAuthorityBump?: number | undefined) => Promise<TransactionInstruction>;
/**
 ...
 * @returns
 */
export declare const cancelOrderByClientId: (program: Program, optionMarketKey: PublicKey, dexProgramId: PublicKey, serumMarketKey: PublicKey, order: Order, marketAuthorityBump?: number | undefined) => Promise<TransactionInstruction>;
