 ...
 */
export declare const closePositionInstruction: (program: Program, size: BN, optionMarket: OptionMarketWithKey, writerTokenSrc: PublicKey, optionTokenSrc: PublicKey, underlyingAssetDest: PublicKey) => TransactionInstruction;
