 ...
 */
export declare const mintOptionsTx: (program: anchor.Program, minterOptionAcct: PublicKey, minterWriterAcct: PublicKey, minterUnderlyingAccount: PublicKey, size: anchor.BN, optionMarket: OptionMarketWithKey) => Promise<{
    tx: string;
}>;
/**
 ...
 */
export declare const mintOptionInstruction: (program: anchor.Program, minterOptionAcct: PublicKey, minterWriterAcct: PublicKey, minterUnderlyingAccount: PublicKey, size: anchor.BN, optionMarket: OptionMarketWithKey) => Promise<{
    ix: any;
