 ...
 * @returns
 */
export declare const exerciseOptionsInstruction: (program: Program, size: BN, optionMarket: OptionMarketWithKey, exerciserOptionTokenSrc: PublicKey, underlyingAssetDest: PublicKey, quoteAssetSrc: PublicKey, opts?: {
