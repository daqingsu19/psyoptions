 ...
 */
export declare const burnWriterForQuote: (program: Program, size: BN, optionMarket: OptionMarketWithKey, writerTokenSrc: PublicKey, writerQuoteDest: PublicKey) => TransactionInstruction;
