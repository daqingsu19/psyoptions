 ...
 * @returns
 */
export declare const initializeSerumMarket: (program: Program, { asks, bids, eventQueue, optionMarketKey, optionMint, pcDustThreshold, pcLotSize, pcMint, serumProgramKey, }: {
