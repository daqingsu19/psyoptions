 ...
 * @returns
 */
export declare const initializeMarket: (program: anchor.Program, { expirationUnixTimestamp, quoteAmountPerContract, quoteMint, underlyingAmountPerContract, underlyingMint, }: {
