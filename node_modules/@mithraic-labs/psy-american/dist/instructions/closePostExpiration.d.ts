 ...
 */
export declare const closePostExpirationInstruction: (program: Program, size: BN, optionMarket: OptionMarketWithKey, writerTokenSrc: PublicKey, underlyingAssetDest: PublicKey) => TransactionInstruction;
