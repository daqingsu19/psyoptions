...
const getOrAddAssociatedTokenAccountTx = (associatedAddress, mintKey, provider, owner = FEE_OWNER_KEY) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return splToken.Token.createAssociatedTokenAccountInstruction(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, mintKey, associatedAddress, owner, provider.wallet.publicKey);
});
...
const findOpenOrdersForOptionMarkets = (program, serumProgramId, optionMarketKeys) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    openOrdersInfos.forEach((info, index) => {
        if (!info)
            return;
        openOrders.push(new serum.OpenOrders(openOrdersKeys[index], serum.OpenOrders.getLayout(serumProgramId).decode(info.data), serumProgramId));
    });
    return openOrders;
});
const deriveSerumMarketAddress = (program, optionMarketKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return web3_js.PublicKey.findProgramAddress([optionMarketKey.toBuffer(), textEncoder$2.encode("serumMarket")], program.programId);
});
/**
...
const getMarketAndAuthorityInfo = (program, optionMarketKey, dexProgramId) => __awaiter(void 0, void 0, void 0, function* () {
    const [serumMarketKey, _serumMarketBump] = yield deriveSerumMarketAddress(program, optionMarketKey);
    const [marketAuthority, marketAuthorityBump] = yield web3_js.PublicKey.findProgramAddress([
...
const initializeSerumMarket = (program, { asks, bids, eventQueue, optionMarketKey, optionMint, pcDustThreshold, pcLotSize, pcMint, serumProgramKey, }) => __awaiter(void 0, void 0, void 0, function* () {
    const [requestQueue] = yield web3_js.PublicKey.findProgramAddress([optionMarketKey.toBuffer(), textEncoder$1.encode("requestQueue")], program.programId);
    const [coinVault] = yield web3_js.PublicKey.findProgramAddress([optionMarketKey.toBuffer(), textEncoder$1.encode("coinVault")], program.programId);
    const [pcVault] = yield web3_js.PublicKey.findProgramAddress([optionMarketKey.toBuffer(), textEncoder$1.encode("pcVault")], program.programId);
...
const marketLoader = (program, optionMarketKey, marketAuthorityBump, dexProgramId, marketKey) => __awaiter(void 0, void 0, void 0, function* () {
    return (new serum.MarketProxyBuilder()
